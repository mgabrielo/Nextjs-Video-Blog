...
const UploadVideoModal = ({ onUpload }: UploadVideoModalProps) => {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col bg-zinc-800 justify-center w-5/6 h-5/6 rounded-xl z-50 ">
      ...
      <div className="flex flex-col gap-3 justify-center items-center h-full">
        <MediaUpload onChange={handleUpload}>
          <IconButton classname={"bg-stone-700"}>
